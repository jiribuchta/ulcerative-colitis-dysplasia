...
def apply_mlflow_compat_patch() -> None:
    ...
    def _safe_list_model_artifacts(self, *args, **kwargs):
        try:
    ...
    RunsArtifactRepository._list_model_artifacts = _safe_list_model_artifacts
    RunsArtifactRepository._list_model_artifacts_patched = True
